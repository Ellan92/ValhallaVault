...
namespace TestValhallaVault
{
	public class CalleUnitTest
	{
		...
		public void LimitToPassSubcategory_ReturnsCorrectValue()
		{
			...
			subcategory.Questions = new List<QuestionModel>(); // Fyll i detta med riktiga testdata
		...
		public void UserPassedSubcategory_ReturnsCorrectResult(int totalQuestions, int correctAnswers, bool expected)
		{
			...
			// Act
			var actual = completionManager.UserPassedSubcategory(subcategory, correctAnswers, expected);
